...
urlpatterns = [
    ...
    path('product/category/<slug:slug>', product_list_by_category, name='product_list_by_category'),
#  
...
# cart section
    ...
    # checkout' s
     ...
     path('order/<int:order_id>/received/', mark_order_as_received, name='mark-order-received'),
